...
public class DatabaseTest {
	public static void main(String[] args) {
		...
		db.addPerson(new Person("ariana", "Actress", AgeCategory.adult, EmploymentCategory.employed, "9632", true, Gender.female));
		db.addPerson(new Person("spens", "actor", AgeCategory.adult, EmploymentCategory.employed, "9632", true, Gender.male));
		try {
			db.save();
			//db.retrieve();
